                ...
                <div class="panel-body">
                    <form method="POST" class="form-horizontal" action="../xsubmit.php" onsubmit="submitRemarksButton.disabled = true; return true;">
                        ...
                        <div class="col-sm-2" style="float: right;">
                            ...
                            <input type="hidden" name="submitremarksVM" value="true">
                            <button class="btn btn-success btn-block" name="submitRemarksVM" type="submit"><span style="color:#ffcf40" class="fa fa-save"></span> Submit</button>
                        </div>
