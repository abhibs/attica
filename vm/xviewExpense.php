							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										// Define daily and monthly expense types
										$dailyTypes = ["Daily Expenses", "Petrol Expenses", "Pooja Expenses", "Travelling Expenses", "Courier Expenses"];
										$monthlyTypes = ["Office Rent", "Electricity Bill", "Internet Bill", "Telephone Bill", "Water Bill", "Salary", "Salary Advance", "Incentives", "Advertisement Expenses", "Office Maintenance", "Legal Expense", "MD Sir Payment", "Stationary Expense", "IT Expense", "Others"];

										foreach ($expPending as $key => $value) {

											// Determine row color based on expense type
											$rowStyle = "";
											if (in_array($value['type'], $dailyTypes)) {
												$rowStyle = "style='background-color:#d4edda;'"; // light green
											} elseif (in_array($value['type'], $monthlyTypes)) {
												$rowStyle = "style='background-color:#f8d7da;'"; // light red
											}
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										// Define daily and monthly expense types
										$dailyTypes = ["Daily Expenses", "Petrol Expenses", "Pooja Expenses", "Travelling Expenses", "Courier Expenses"];
										$monthlyTypes = ["Office Rent", "Electricity Bill", "Internet Bill", "Telephone Bill", "Water Bill", "Salary", "Salary Advance", "Incentives", "Advertisement Expenses", "Office Maintenance", "Legal Expense", "MD Sir Payment", "Stationary Expense", "IT Expense"];
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										// Define expense type categories
										$dailyTypes = ["Daily Expenses", "Petrol Expenses", "Pooja Expenses", "Travelling Expenses", "Courier Expenses"];
										$monthlyTypes = ["Office Rent", "Electricity Bill", "Internet Bill", "Telephone Bill", "Water Bill", "Salary", "Salary Advance", "Incentives", "Advertisement Expenses", "Office Maintenance", "Legal Expense", "MD Sir Payment", "Stationary Expense", "IT Expense"];
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										// Define expense type categories
										$dailyTypes = ["Daily Expenses", "Petrol Expenses", "Pooja Expenses", "Travelling Expenses", "Courier Expenses"];
										$monthlyTypes = ["Office Rent", "Electricity Bill", "Internet Bill", "Others", "Telephone Bill", "Water Bill", "Salary", "Salary Advance", "Incentives", "Advertisement Expenses", "Office Maintenance", "Legal Expense", "MD Sir Payment", "Stationary Expense", "IT Expense"];

										foreach ($expRejected as $key => $value) {

											// Determine row background color based on expense type
											$rowStyle = "";
											if (in_array($value['type'], $dailyTypes)) {
												$rowStyle = "style='background-color:#d4edda;'"; // Light green for daily
											} elseif (in_array($value['type'], $monthlyTypes)) {
												$rowStyle = "style='background-color:#f8d7da;'"; // Light red for monthly
											}
