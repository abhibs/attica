<aside id="menu" style="overflow:scroll;overflow-x:hidden">
	<div id="sidebar-collapse">
		<ul class="nav" id="side-menu">
			...
			<li><a href="viewRegistered.php"><span class="nav-label"><i style="color:#990000" class="fa fa-check-square-o"></i> Registered</span></a></li>
			<li><a href="vmEnquiryReport.php"><span class="nav-label"><i style="color:#990000" class="fa fa-pencil"></i>Update Enquiry</span></a></li>
			<!--<li><a href="viewRegisteredGraded.php"><span class="nav-label"><i style="color:#990000" class="fa fa-star"></i> Grade-wise</span></a></li>-->
			<li><a href="VMDossier.php"><span class="nav-label"><i style="color:#990000" class="fa fa-user-circle-o"></i> Dossier</span></a></li>
			<li><a href="BMinfo.php"><span class="nav-label"><i style="color:#990000" class="fa fa-user-circle-o"></i> BMs Info</span></a></li>
			<li><a href="zbilllStatus.php"><span class="nav-label"><i style="color:#990000" class="fa fa-check-circle"></i> Verify Bills</span></a></li>
			<li><a href="zbilllStatus1.php"><span class="nav-label"><i style="color:#990000" class="fa fa-id-card-o"></i> Bills</span></a></li>
			<li><a href="xmanageCustomerVM.php"><span class="nav-label"><i style="color:#990000" class="fa fa-ban"></i> Blocked</span></a></li>
