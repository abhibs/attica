<?php
    ...
    $vmBranchListRow = mysqli_fetch_assoc(mysqli_query($con, "SELECT agentId, branch FROM vmagent WHERE agentId='" . mysqli_real_escape_string($con, $empId) . "'"));
    $branches = [];
    ...
    // ---------------- ALL ACTIVE BRANCHES (for the dropdown on the left form) ----------------
    $branchList = [];
                                ...
                                <?php
                                    foreach ($branchList as $value) {
                                        ...
                                        echo '<option value="' . htmlspecialchars($bid) . '" data-branch-name="' . htmlspecialchars($bname) . '">'
                                             . htmlspecialchars($bid) . ' - ' . htmlspecialchars($bname)
                                             . '</option>';
                                    }
                                ?>
                            </select>
