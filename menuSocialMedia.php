<aside id="menu" style="overflow:scroll;overflow-x:hidden">
    <div id="sidebar-collapse">
        <ul class="nav" id="side-menu">
		    ...
		    <li><a href="job.php"><span class="nav-label"><i style="color:#990000" class="fa fa-user"></i> Candidates</span></a></li>
			 <li><a href="callcenter_dashboard.php"><span class="nav-label"><i style="color:#990000" class="fa fa-phone-square"></i> Call Center</span></a></li>
