...
$username = $_SESSION['username'] ?? ''; // used for Zonal/SubZonal mapping

if ($type === 'Zonal' || $type === 'SubZonal') {
...
<style>
    ...
    /* Chat modal styles (same style as elsewhere; footer has modal + JS) */
    ...
    <?php echo "<pre>SESSION username: " . htmlspecialchars($username, ENT_QUOTES, 'UTF-8') . "</pre>"; ?>
<div id="wrapper">
    <div class="content">
