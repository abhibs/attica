...
/* GOLD RATE */
$cityGoldRate = mysqli_fetch_assoc(mysqli_query($con, "SELECT cash, transferRate FROM gold WHERE date='$date' AND type='Gold' AND city='AGPL000' ORDER BY id DESC LIMIT 1"));
$stateGoldRate = mysqli_fetch_assoc(mysqli_query($con, "SELECT cash, transferRate FROM gold WHERE date='$date' AND type='Gold' AND city='AGPL000' ORDER BY id DESC LIMIT 1"));
$citySilverRate = mysqli_fetch_assoc(mysqli_query($con, "SELECT cash FROM gold WHERE date='$date' AND type='Silver' AND city='AGPL000' ORDER BY id DESC LIMIT 1"));
$stateSilverRate = mysqli_fetch_assoc(mysqli_query($con, "SELECT cash FROM gold WHERE date='$date' AND type='Silver' AND city='AGPL000' ORDER BY id DESC LIMIT 1"));
