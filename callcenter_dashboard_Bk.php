...
$conversionCogPct = ($denUnique > 0) ? (($prevBRCount + $prevEnqCount) * 100.0 / $denUnique) : 0.0;
$billedCogPct     = ($denUnique > 0) ? ( $prevBRCount               * 100.0 / $denUnique) : 0.0;
...
<!-- Total Calls Tile -->
<div class="hpanel stats" id="allCallsTile">
