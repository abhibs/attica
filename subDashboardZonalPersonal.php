...
$branchListStr = "";
$branchDataArr = [];
$branchQuery = mysqli_query($con, "SELECT b.branchId, b.branchName, g.cash
	FROM branch b
	LEFT JOIN gold g ON g.city = b.branchId 
	AND g.type = 'Gold' AND g.date = CURDATE()
	WHERE b.ezviz_vc='$empId' AND b.status=1");
while ($row = mysqli_fetch_assoc($branchQuery)) {
	$branchDataArr[$row['branchId']] = $row['branchName'];
	$branchRateArr[$row['branchId']] = $row['cash'];
...
$enqQuery = mysqli_fetch_assoc(mysqli_query($con, "
    ...
    FROM walkin
    WHERE date = '$date'
      AND issue != 'Rejected' AND gwt != 0 AND metal='Gold'
					...
					<div class="panel-body h-200">
						...
						<div class="m-t-xl">
						 ...
						 <div class="row m-t-md" style="padding-top: 60px; padding-left: 10px;">
							<div class="col-lg-4">
								<h3 class="no-margins font-extra-bold text-success">
									<!?php echo isset($transQuery['silver_grossw']) ? number_format($transQuery['silver_grossw'], 2) : '0.00'; ?>
								</h3>
								<div class="font-bold">Gross Weight</div>
							</div>
							...
							<!-- <div class="col-lg-4">
								...
								<div class="font-bold">Enquiry Netw</div>
		...
		<div class="row">
			<div class="col-lg-3">
				<div class="hpanel stats">
					<div class="panel-body h-200">
						<div class="stats-title pull-left">
							<h4 style="font-weight: 900">Gold Enquiry</h4>
						</div>
						...
						<div class="row m-t-md" style="padding-top: 60px; padding-left: 10px;">
							<div class="col-xs-6">
								...
								<div class="font-bold">Physical</div>
							</div>
							<div class="col-xs-6">
								<h3 class="no-margins font-extra-bold text-success">
			...
			<!--<div class="col-lg-3">
				<div class="hpanel stats">
					<div class="panel-body h-200 text-center">
						<!?php
						
						$today = date("Y-m-d");

						$zonalCOGQuery = mysqli_query($con, "
							SELECT 
								ROUND(
									(
						...
						$zonalCOG = mysqli_fetch_assoc($zonalCOGQuery);
						$todayZonalCOG = $zonalCOG['cogPercent'] ? $zonalCOG['cogPercent'] : 0;
						?>
						<div style="padding-top: 60px;">
							<h3 class="no-margins font-extra-bold text-success">
								<!?php echo $todayZonalCOG; ?>%
							</h3>
							<h3 class="font-bold">Today's COG</h3>
						</div>
					</div>
					<div class="panel-footer">
						<b>Attica Gold Pvt Ltd</b> &nbsp;
				...
				<div class="hpanel stats">
					<div class="panel-body h-200 text-center">
						<div style="padding-top: 60px;">
							...
							<h3 class="font-bold">Average Purity</h3>
						</div>
					</div>
					<div class="panel-footer">
						<b>Attica Gold Pvt Ltd</b>
