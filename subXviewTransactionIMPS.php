...
<div id="wrapper">
			...
			<div class="hpanel">
	            ...
	            <div class="tab" role="tabpanel">
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation"><a href="#approved" onclick="subTransactionResult('approved')" aria-controls="approved" role="tab" data-toggle="tab"><i class="fa_Icon fa fa-check"></i> Verified</a></li>
						<li role="presentation"><a href="#rejected" onclick="subTransactionResult('rejected')" aria-controls="rejected" role="tab" data-toggle="tab"><i class="fa_Icon fa fa-times"></i> Rejected</a></li>
					</ul>
									...
									<table id="pending-datatable" class="table table-bordered">
										...
										<tbody>
											<?php
												...
												WHERE T.date='$date' AND T.status='ZONAL-VERIFIED' AND T.paymentType='NEFT/RTGS' AND T.branchId=B.branchId AND B.ezviz_vc = '$employeeId'
												ORDER BY T.time");
	...
	<script>
		...
		function subTransactionResult(trans_status){
			$('#'+trans_status+'-datatable').DataTable().clear().destroy();
		    $.ajax({
				url: "xSubTransactionAjax.php",
				type: "post",
