...
$otherData = mysqli_fetch_assoc(mysqli_query($con, "SELECT
        (SELECT COUNT(*) FROM walkin WHERE date='$date' AND havingG='with' AND branchId !='' AND issue!='Rejected' ) AS withGold,
        (SELECT COUNT(*) FROM walkin WHERE date='$date' AND havingG='without' AND branchId !='' AND issue!='Rejected' ) AS withoutGold,
                                                ...
                                                <div class="m-t-xl">
                                                        <div class="row">
                                                                <form action="" method="GET">
                                                                        <div class="col-xs-9">
                                                                                <input type="date" class="form-control" name="date" placeholder="Branch"
                                                                                        required>
                                                                        </div>
                                                                        <div class="col-xs-3">
                                                                                <button class="btn btn-success"><i style="color:#FFFFFF"
                                                        ...
                                                        <div class="row">
                                                                <div class="col-xs-8">
                                                                        ...
                                                                        <h4><i class="fa fa-rupee"></i>
                                                                                <?php echo $otherData['goldCashRate'] . " / " . $otherData['goldIMPSRate']; ?>
                                                                        </h4>
                                                                </div>
                                                                <div class="col-xs-4">
                                ...
                                <div class="hpanel stats">
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="col-xs-6">
                                                                        ...
                                                                        <h4><i class="fa fa-edit"></i>
                                                                                <?php echo ($bang_bills + $chn_bills + $hyd_bills + $kar_bills + $tn_bills + $apt_bills + $sil_bills); ?>
                                                                        </h4>
                                                                </div>
                                                        </div>
                                                </div>
                                        ...
                                        <div class="panel-footer">
                                                ...
                                                <!-- <i class="fa fa-angle-double-right"></i> <a
                                                        href="viewCustomers.php">View Details</a> -->
                                        </div>
                                </div>
                        </div>
                                ...
                                <div class="hpanel stats">
                                        ...
                                        <div class="panel-footer">
                                                <b>Attica Gold Pvt Ltd</b> &nbsp; <i class="fa fa-angle-double-right"></i> <a
                                                        href="walkinout.php">View Details</a>
                                        </div>
                                </div>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="col-lg-3">
                                <div class="hpanel stats">
                                                ...
                                                <div class="m-t-xl">
                                                        <div class="row">
                                                                <div class="col-xs-6">
                                                                        ...
                                                                        <h4><i class="fa fa-institution"></i>
                                                                                <?php echo count(array_unique($busBranches)); ?></h4>
                                                                </div>
                                                                <div class="col-xs-6">
                                                                        <small class="stats-label">Golden Ducks</small>
                                                                        <h4><i class="fa fa-institution"></i>
                                                                                <?php echo $activeBranches - count(array_unique($busBranches)); ?></h4>
                                                                </div>
                                                        </div>
                                                </div>
                                        </div>
                                        <div class="panel-footer">
                                                <b>Attica Gold Pvt Ltd</b> &nbsp; <i class="fa fa-angle-double-right"></i> <a
                                                        href="aggregate.php">View Details</a>
                                        </div>
                                </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                                <div class="hpanel stats">
                                        <div class="panel-body">
                                                <div class="row">
                                                        <div class="stats-title pull-left">
                                                                <h3 class="font-extra-bold no-margins text-success">KA
                                                                        Bills<?php echo " (" . ($bang_bills + $kar_bills) . ")"; ?></h3>
                                                        </div>
                                                        <div class="stats-icon pull-right">
                                                                <i class="fa fa-users fa-2x"></i>
                                                        </div>
                                        ...
                                        <div class="panel-footer">
                                                <b>Attica Gold Pvt Ltd</b> &nbsp; <i class="fa fa-angle-double-right"></i> <a
                                                        href="viewbill.php">View Details</a>
                                        </div>
                                </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                                <div class="hpanel stats">
                                        <div class="panel-body">
                                                <div class="row">
                                                        <div class="stats-title pull-left">
                                                                <h3 class="font-extra-bold no-margins text-success">TN
                                                                        Bills<?php echo " (" . ($chn_bills + $tn_bills) . ")"; ?></h3>
                                                        </div>
                                                        <div class="stats-icon pull-right">
                                                                <i class="fa fa-users fa-2x"></i>
                                                        </div>
                        ...
                        <div class="col-lg-3">
                                <div class="hpanel stats">
                                        <div class="panel-body">
                                                <div class="row">
                                                        <div class="stats-title pull-left">
                                                                <h3 class="font-extra-bold no-margins text-success">AP/T
                                                                        Bills<?php echo " (" . ($hyd_bills + $apt_bills) . ")"; ?></h3>
                                                        </div>
                                                        <div class="stats-icon pull-right">
                                                                <i class="fa fa-users fa-2x"></i>
                                                        </div>
...
<script>
        ...
        <div class="m-t-xl">
          <div class="row">
            <div class="col-xs-6">
              ...
              <h4>
                <?php
                  $totalGrossW = number_format(($bang_grossW + $chn_grossW + $hyd_grossW + $kar_grossW + $tn_grossW + $apt_grossW), 2);
                ?>
                <span class="mask-toggle" data-text="<?php echo $totalGrossW; ?>"></span>
              </h4>
            </div>
            <div class="col-xs-6">
              ...
              <h4>
                <?php
                  $totalNetA = preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", ($bang_netA + $chn_netA + $hyd_netA + $kar_netA + $tn_netA + $apt_netA));
                ?>
                <span class="mask-toggle" data-text="<?php echo $totalNetA; ?>"></span>
              </h4>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-xs-6">
              ...
              <h4>
                ...
                ?>
                <span class="mask-toggle" data-text="<?php echo $bang_grossW; ?>"></span>
                <small class="text-muted"> (<?php echo $margin; ?>)</small>
              </h4>
            </div>
            <div class="col-xs-6">
              <small class="stats-label"> Karnataka</small>
              <h4>
                ...
                ?>
                <span class="mask-toggle" data-text="<?php echo $kar_grossW; ?>"></span>
                <small class="text-muted"> (<?php echo $margin; ?>)</small>
              </h4>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xs-6">
              ...
              <h4>
                ...
                ?>
                <span class="mask-toggle" data-text="<?php echo $chn_grossW; ?>"></span>
                <small class="text-muted"> (<?php echo $margin; ?>)</small>
              </h4>
            </div>
            <div class="col-xs-6">
              ...
              <h4>
                ...
                ?>
                <span class="mask-toggle" data-text="<?php echo $tn_grossW; ?>"></span>
                <small class="text-muted"> (<?php echo $margin; ?>)</small>
              </h4>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xs-6">
              ...
              <h4>
                ...
                ?>
                <span class="mask-toggle" data-text="<?php echo $hyd_grossW; ?>"></span>
                <small class="text-muted"> (<?php echo $margin; ?>)</small>
              </h4>
            </div>
            <div class="col-xs-6">
              ...
              <h4>
                ...
                ?>
                <span class="mask-toggle" data-text="<?php echo $apt_grossW; ?>"></span>
                <small class="text-muted"> (<?php echo $margin; ?>)</small>
              </h4>
            </div>
          </div>
  ...
  <div class="hpanel stats">
        ...
        <div class="row">
          <div class="col-xs-6">
            ...
            <h5>
              ...
              <span class="mask-toggle" data-text="<?php echo $sil_grossW; ?>"></span>
            </h5>
          </div>
          <div class="col-xs-6">
            <small class="stats-label">Net Amount</small>
            <h5>
              <?php
                // If you want Indian comma formatting, uncomment the next line:
                // $sil_netA_fmt = preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $sil_netA);
                // echo via $sil_netA_fmt instead of $sil_netA
              ?>
              <span class="mask-toggle" data-text="<?php echo $sil_netA; ?>"></span>
            </h5>
          </div>
        </div>
      </div>
    ...
    <div class="panel-footer">
      ...
      <a href="silverReports.php">View Details</a>
    </div>
  </div>
</div>
                                                ...
                                                <div class="m-t-xl">
                                                        <div class="row">
                                                                <div class="col-xs-6">
                                                                        ...
                                                                        <h5><?php echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", ($cashAmount + $otherData['relCash'])); ?>
                                                                        </h5>
                                                                </div>
                                                                <div class="col-xs-6">
                                                                        <small class="stats-label">IMPS</small>
                                                                        <h5><?php echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", ($impsAmount + $otherData['relIMPS'])); ?>
                                                                        </h5>
                                                                </div>
                                                        </div>
                                                </div>
                                                ...
                                                <div class="m-t-xl">
                                                        <div class="row">
                                                                ...
                                                                <div class="col-xs-6">
                                                                        ...
                                                                        <h5><?php echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $otherData['Expense']); ?>
                                                                        </h5>
                                                                </div>
                                                        </div>
                                                </div>
  ...
  <div class="hpanel">
    ...
    <div class="panel-body list">
      <div class="list-item-container">
        ...
        // Fetch enquiry count + total grams (gwt) zone-wise (by ezviz_vc), with employee name
        $zonalEnquiry = mysqli_query($con, "
          SELECT
            ...
            COALESCE(SUM(CASE WHEN w.id IS NOT NULL THEN w.gwt ELSE 0 END), 0) AS enquiryGrams
          FROM (
            SELECT '1003665' AS ezviz_vc UNION ALL
            SELECT '1000336' UNION ALL
            SELECT '1000423' UNION ALL
	    SELECT '1005678' UNION ALL
	    SELECT '1001038' UNION ALL 
	    SELECT '1002380' UNION ALL
	    SELECT '1001627' UNION ALL
	    SELECT '1001461' UNION ALL
            SELECT '1000735'
          ) AS z
	   ...
	   AND w.metal = 'Gold'
        ...
        $i = 1;
        while ($rowEnquiry = mysqli_fetch_assoc($zonalEnquiry)) {
        ?>
          <div class="list-item"
               style="display:flex; justify-content:space-between; align-items:center; padding:5px 0; border-bottom:1px solid #eee;">
            <span><b><?php echo $i; ?>.</b> <?php echo $rowEnquiry['zoneName']; ?></span>
            <span>
              Enquiry: <b><?php echo (int)$rowEnquiry['enquiryCount']; ?></b>
              &nbsp; Enquiry Grams: <b><?php echo (int)$rowEnquiry['enquiryGrams']; ?></b> g
            </span>
          </div>
        <?php
          $i++;
  ...
  <div class="hpanel">
    ...
    <div class="panel-body list">
      <div class="list-item-container">
        ...
        $zonalCog = mysqli_query($con, "
          SELECT 
            COALESCE(e.name, CONCAT('No Zone (', z.ezviz_vc, ')')) AS zoneName,
            COALESCE(
              ROUND(
                (
                  COALESCE(SUM(t.totalNetW), 0) /
                  NULLIF(COALESCE(SUM(w.totalWalkinNwt), 0) + COALESCE(SUM(t.totalNetW), 0), 0)
                ) * 100, 
                2
              ),
              0
            ) AS cogPercent,
            COALESCE(SUM(t.totalGrossW), 0) AS totalGrossW
          FROM (
            SELECT '1003665' AS ezviz_vc UNION ALL
            SELECT '1000336' UNION ALL
            SELECT '1000423' UNION ALL
	    ...
	    SELECT '1001461' UNION ALL
          ...
          /* Aggregate walkin per branch (today, non-rejected, Gold only) */
          LEFT JOIN (
            SELECT branchId, SUM(nwt) AS totalWalkinNwt
            FROM walkin
          ...
          /* Aggregate trans per branch (today, approved) */
          LEFT JOIN (
            SELECT branchId,
                   SUM(netW)   AS totalNetW,
                   SUM(grossW) AS totalGrossW
            FROM trans
            WHERE DATE(date) = '$date'
	      AND status = 'Approved'
		AND metal = 'Gold'
          ...
          GROUP BY z.ezviz_vc, e.name
          ORDER BY cogPercent DESC, zoneName ASC
        ");

        $i = 1;
        while ($row = mysqli_fetch_assoc($zonalCog)) {
        ?>
<div class="list-item"
     style="display:flex; justify-content:space-between; align-items:center; padding:5px 0; border-bottom:1px solid #eee;">
  <span><b><?php echo $i; ?>.</b> <?php echo $row['zoneName']; ?></span>
  <span>
    COG : <b><?php echo $row['cogPercent']; ?>%</b>
    &nbsp; &nbsp;
    Billed Grams:
    <b>
      <?php $billed = number_format((float)$row['totalGrossW'], 2); ?>
      <span class="mask-toggle" data-text="<?php echo $billed; ?>"></span>
    </b> g
  </span>
</div>
    ...
    <div class="panel-footer">
      <b>Attica Gold Pvt Ltd</b>&nbsp; <i class="fa fa-angle-double-right"></i>
      <a href="overallReport.php">View Details</a>
    </div>
  </div>
</div>
                                ...
                                <div class="hpanel">
                                        ...
                                        <div class="panel-body list">
                                                <div class="stats-title pull-left">
                                                        ...
                                                        <div class="col-xs-2">
                                                                <a class="btn btn-success" id="branchIDsearch"><i style="color:#FFFFFF"
                                                ...
                                                <div class="list-item-container" style="margin-top:23px;">
                                                        ...
                                                        <div class="list-item">
                                                                ...
                                                                <div class="pull-right"><i class="fa fa-balance-scale"></i><b><span
                                                                                        id="grossWeight"></span></b></div>
                                                        </div>
                                                        <div class="list-item">
                                                                <h6 class="no-margins font-extra-bold">Net Amount</h6>
                                                                <div class="pull-right"><i class="fa fa-rupee"></i><b><span id="netAMount"></span></b>
                                                                </div>
                                                        </div>
                                                        <div class="list-item">
                                                                <h6 class="no-margins font-extra-bold">Gold Stock</h6>
                                                                <div class="pull-right"><i class="fa fa-balance-scale"></i><b><span
                                                                                        id="goldRemain"></span></b></div>
                                                        </div>
                                                        <div class="list-item">
                                                                <h6 class="no-margins font-extra-bold">Balance Amount</h6>
                                                                <div class="pull-right"><i class="fa fa-rupee"></i><b><span id="balance"></span></b>
                                                                </div>
                                                        </div>
                                                </div>
                                        </div>
                                        <div class="panel-footer">
                                                <b>Attica Gold Pvt Ltd</b> &nbsp; <i class="fa fa-angle-double-right"></i> <a
                                                        href="dailyClosingR.php">View Details</a>
                                        </div>
                                </div>
                        </div>
                        <!--  TOP BRANCHES  -->
                        <div class="col-lg-3">
                                <div class="hpanel">
                                                        ...
                                                        while ($rowTB = mysqli_fetch_assoc($topBranch)) {
                                                                ...
                                                                <div class="list-item">
                                                                        <h3 class="no-margins font-extra-bold text-success">
                                                                                <?php echo $i . ". " . $rowTB['branchName']; ?>
                                                                        </h3>
                                                                        <small><b><?php echo $rowEmployee1['name']; ?></b> <a
                                                                                        href="tel:<?php echo $rowEmployee1['contact']; ?>"><i style="color:#009900"
                                                                                                class="fa fa-phone-square fa-2x"></i></a></small>
                                                                        <div class="pull-right"><i class="fa fa-balance-scale"></i>
                                                                                <b><?php echo $rowTB['gw']; ?></b>
                                                                        </div>
                                                                </div>
                                                                <?php $i++;
                                                        } ?>
                                        ...
                                        <div class="panel-footer">
                                                <b>Attica Gold Pvt Ltd</b> &nbsp; <i class="fa fa-angle-double-right"></i> <a
                                                        href="topbranches.php">View Details</a>
                                        </div>
                                </div>
                        </div>
                                        ...
                                        <div class="panel-body list">
                                                <div class="list-item-container">
                                                        ...
                                                        while ($rowGoldRemaining = mysqli_fetch_assoc($goldRemainBranch)) {
                                                                ...
                                                                <div class="list-item">
                                                                        <h3 class="no-margins font-extra-bold text-success">
                                                                                <?php echo $i . ". " . $rowGoldRemaining['branchName']; ?>
                                                                        </h3>
                                                                        <small><b><?php echo $rowEmployee3['name']; ?></b> <a
                                                                                        href="tel:<?php echo $rowEmployee3['contact']; ?>"><i style="color:#009900"
                                                                                                class="fa fa-phone-square fa-2x"></i></a></small>
                                                                        <div class="pull-right"><i class="fa fa-balance-scale"></i>
                                                                                <b><?php echo $rowGoldRemaining['nw']; ?></b>
                                                                        </div>
                                                                </div>
                                                                <?php $i++;
                                                        } ?>
                                        ...
                                        <div class="panel-body list">
                                                <div class="list-item-container">
                                                        ...
                                                        while ($rowExpense = mysqli_fetch_assoc($topExpense)) {
                                                                ...
                                                                <div class="list-item">
                                                                        <h3 class="no-margins font-extra-bold text-success">
                                                                                <?php echo $i . ". " . $rowExpense['branchName']; ?>
                                                                        </h3>
                                                                        <small><b><?php echo $rowEmployee2['name']; ?></b> <a
                                                                                        href="tel:<?php echo $rowEmployee2['contact']; ?>"><i style="color:#009900"
                                                                                                class="fa fa-phone-square fa-2x"></i></a></small>
                                                                        <div class="pull-right"><i class="fa fa-rupee"></i>
                                                                                <b><?php echo $rowExpense['expense']; ?></b>
                                                                        </div>
                                                                </div>
                                                                <?php $i++;
                                                        } ?>
