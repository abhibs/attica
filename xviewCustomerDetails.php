  	 ...
  	 <span class="timerDisplay" data-starttime="<?php echo $billData['time']; ?>">00:00</span></h4>					
		...
		<div class="col-lg-3">
			<div class="hpanel">
				...
				<?php if($billData['status'] == 'ZONAL-VERIFIED' && ($type=='ApprovalTeam' || $type=='Master' || $type == 'ZonalMaster' || $type == 'SundayUser' )) { ?>
...
<?php echo "<td><a class='btn btn-success btn-md' target='_blank' href='Invoice.php?id=".base64_encode($billData['id'])."'><i style='color:#ffcf40' class='fa fa-eye'></i> View</a></b></td>"; ?>
			...
			async function updateTransUpload(btn){
				...
				if(conf){
					...
					if(result['message'] == "success"){
						...
						window.location = "xviewTransaction.php";
					}
					else{
						console.log(result);
...
document.addEventListener("DOMContentLoaded", function () {
	const form = document.querySelector("form[action='xapprovalAR.php']");
