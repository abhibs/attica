									...
									<table id="pending-datatable" class="table table-bordered">
										...
										<tbody>
											<?php
												...
												WHERE T.date='$date' AND T.status='ZONAL-VERIFIED' AND T.paymentType='Cash' AND T.branchId=B.branchId
												ORDER BY T.time");
												...
												while($row = mysqli_fetch_assoc($sql)){
													...
													echo "<td style='text-align: center;'><a class='btn btn-success btn-md' href='xviewCustomerDetails.php?id=".$row['phone']."&ids=".$row['id']."'><i style='color:#ffcf40' class='fa fa-check'></i> Action</a></b></td>";
