							...
							<div class="panel-body">
								<table id="example2" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<?php
											$i = 1;
											$sqlA = mysqli_query($con,"SELECT expense.*,branch.branchName FROM expense,branch WHERE expense.branchCode=branch.branchId AND expense.status IN ('Pending','Verified') AND expense.date='$date'"); 
