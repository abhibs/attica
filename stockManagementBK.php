					...
					<form method="POST" class="form-horizontal" action="xsubmit.php" enctype="multipart/form-data">
						...
						<div class="col-sm-4">
							...
							<div class="input-group">
								...
								<input type="text" name="standards" class="form-control"
									placeholder="Specification / Standards" autocomplete="off">
							</div>
						</div>
						...
						<div class="col-sm-4">
							...
							<div class="input-group">
								...
								<select name="responsible" id="stock" class="form-control" required>
						...
						<div class="col-sm-4">
							...
							<div class="input-group">
								...
								<input type="text" name="assign" class="form-control" required
									placeholder="Enter Assign Person" autocomplete="off">
							</div>
						</div>
						...
						<div class="col-sm-4">
							...
							<div class="input-group">
								...
								<input type="text" name="vehicle" class="form-control" required
									placeholder="Enter Vehicle Number" autocomplete="off">
							</div>
						</div>
						<div class="col-sm-4">
