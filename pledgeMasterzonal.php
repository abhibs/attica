...
if ($type == 'Zonal') {
	...
	$branch=mysqli_query($con,"SELECT branchId FROM branch where status=1 AND ezviz_vc = '$employeeId'");
}
else {
    $state = "";
}
...
if (isset($_GET['start_date']) && isset($_GET['end_date']) || $type == "Zonal" || $type == 'SubZonal' || $type == 'ZonalMaster') {
