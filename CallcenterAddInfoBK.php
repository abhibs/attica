                ...
                <?php while ($row = mysqli_fetch_assoc($user_entries_result)) { ?>
                  <tr>
                    ...
                    <td><?php echo esc($row['name']); ?></td>
                        ...
                        ?>
                    <td class="phone-cell" data-full="<?php echo esc($mob1_full); ?>"><?php echo esc($mob1_masked); ?></td>
                    <td class="phone-cell" data-full="<?php echo esc($mob2_full); ?>"><?php echo esc($mob2_masked); ?></td>
