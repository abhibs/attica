                                                        ...
                                                        <tbody>
                                                                ...
                                                                if($type == 'SubZonal'){
                                                                        if(date('D') == 'Sun'){
                                                                                $sql = "SELECT 
                                                                                                b.branchName, 
                                                                                                t.id, t.name, t.phone, t.releases, 
                                                                                                t.grossW, t.netW, t.grossA, t.netA, 
                                                                                                t.amountPaid, t.time, t.type, t.comm, 
                                                                                                t.paymentType, t.cashA, t.impsA, 
                                                                                                t.metal, t.branchId,
                                                                                                /* NEW: walkinType from everycustomer */
                                                                                                ( SELECT ec.`walkinType`
                                                                                                  FROM `everycustomer` ec
                                                                                                  WHERE ec.`contact` = t.`phone`
                                                                                                    AND ec.`date` = t.`date`
                                                                                                  ORDER BY ec.`id` DESC
                                                                                                  LIMIT 1
                                                                                                ) AS `walkinType`
