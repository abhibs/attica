			...
			<div class="hpanel">
				...
				<div class="col-xs-4" style="margin-top:6.5px">
					<form action="" method="POST">
						<div class="col-sm-9">
							<input class="form-control" type="date" name="selectedDate" required min="<?php echo $lastdate; ?>" max="<?php echo $date; ?>" onkeypress="return false">
						</div>
						<div class="col-sm-3">
							...
							<tbody>
								<?php
									...
									// ZONAL STATE SELECTION
										$extra_query = "AND t.branchId IN (SELECT branchId FROM branch WHERE ezviz_vc = '$employeeId')";
