...
/* ---------- Use alpha_attica.cust_info_submit for the agent phone universe ---------- */
$cisDb  = 'alpha_attica';
...
/* ---------- Build temp phone set for this agent (UNIVERSE) from cust_info_submit ---------- */
...
/* best-effort index (ignore if IF NOT EXISTS unsupported) */
