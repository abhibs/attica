			...
			<div class="hpanel">
				...
				<div class="panel-body">
					<table class="table table-striped table-hover">
						...
						<tbody>
							<?php
									$ecSQL = mysqli_query($con,"SELECT e.*,b.branchName FROM everycustomer e,branch b WHERE e.branch=b.branchId AND e.date='$date' AND e.status = 'Begin' ORDER BY e.Id DESC");
									while($row = mysqli_fetch_assoc($ecSQL)){
										...
										echo "<td style='text-align:center'><button onClick=\"javascript: return confirm('Please confirm Again');\" class='btn btn-lg' name='editEveryCustomer1' type='submit' style='background-color:transparent'><i class='fa fa-pencil-square-o text-success' style='font-size:16px'></i></button></td>";
										echo "</form></tr>";
									}
							?>
						</tbody>
