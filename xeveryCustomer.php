...
<form method="POST" class="form-horizontal" action="xsubmit.php" enctype="multipart/form-data" autocomplete="off">
  ...
  <input type="hidden" name="employeeId"  value="<?php echo htmlspecialchars($empId, ENT_QUOTES, 'UTF-8'); ?>">
...
-->
  <div class="form-group" style="margin-top:30px">
    ...
    <div class="col-sm-10">
      <input type="file" style="background:#ffcf40" class="form-control" name="customerDocument" id="file" accept=".jpg,.jpeg,.png,.pdf,image/*">
    </div>
  </div>
						...
						<table class="table table-striped table-hover">
							...
							<tbody>
								...
								while ($row = mysqli_fetch_assoc($query)) {
									...
									//	echo "<a href='addPledgeData.php?id=" . $row['Id'] . "' class='btn btn-success btn-user'><i class='fa fa-gavel'></i><b> PLEDGE</b></a> &nbsp;&nbsp;&nbsp;&nbsp;";
