<aside id="menu" style="overflow:scroll;overflow-x:hidden">
	<div id="sidebar-collapse">
		<ul class="nav" id="side-menu">
			...
			<li><a href="zonal.php"><i style="color:#006B76;width:20px;font-size:16px" class="fa pe-7s-like2"></i> Zonal Access</a></li>
			...
			<li><a href="#"><span class="nav-label"><b><i style="color:#1273DE;width:20px;font-size:16px" class="pe-7s-config"></i> Others</b></span><b><span class="fa arrow"></span></b></a>
				...
				<li><a href="assignZonalBranch.php"><i style="color:#008B02;width:20px;font-size:16px" class="fa pe-7s-pin"></i> Zonal </a></li>
				<li><a href="updateDisplay.php"><span class="nav-label"><span style="color:#990000; width:20px" class="fa fa-tv"></span> Display</span></a></li>
		    	    	<li><a href="fraud.php"><i style="color:#006B76;width:20px;font-size:16px" class="fa pe-7s-close-circle"></i> Fraud/Theft</a></li>
				<li><a href="selectWinners.php"><span class="nav-label"><i style="color:#990000" class="fa fa-trophy"></i> Regional Toppers</span></a></li>
