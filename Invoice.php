<?php
	...
	$address = "ADDRESS : ".strtolower($customer['paline']).", \n".$customer['pcity'].", ".$customer['pstate']."-".$customer['ppin']."\n";
	...
	$pdf->Cell(51, 8, "BILL ID", 1, 0, 'L', true);
	$pdf->Cell(50, 8, $trans['billId'], 1, 1, 'L');

	
	$pdf->Cell(35, 8, "CUSTOMER NAME", 1, 0, 'L', true);
	$pdf->Cell(54, 8, $trans['name'], 1, 0, 'L');
	$pdf->Cell(51, 8, "DATE", 1, 0, 'L', true);
	$pdf->Cell(50, 8, date("d-m-Y", strtotime($trans['date'])), 1, 1, 'L');
	
	$pdf->Cell(35, 8, "CONTACT", 1, 0, 'L', true);
	$pdf->Cell(54, 8, $trans['phone'], 1, 0, 'L');
	$pdf->Cell(51, 8, "TIME", 1, 0, 'L', true);
	$pdf->Cell(50, 8, $trans['time'], 1, 1, 'L');
	...
	$pdf->Cell(35, 8, "ID PROOF", 1, 0, 'L', true);
	$pdf->Cell(54, 8, $customer['idNumber'], 1, 0, 'L');
	$pdf->Cell(51, 8, "ADDRESS PROOF", 1, 0, 'L', true);
	$pdf->Cell(50, 8, $customer['addNumber'], 1, 1, 'L'); // <-- line break here
	$pdf->Ln(1);
	...
	// $pdf->SetFont('Arial', 'B', '8');
	// $pdf->Cell(35, 7, "ID PROOF", 1, 0, 'L', true);
	// $pdf->Cell(54, 7, $customer['idNumber'], 1, 0, 'L');
	// $pdf->SetXY(132, 76);
	// $pdf->Cell(33, 7, "ADDRESS PROOF", 1, 1, 'L', true);
	// $pdf->Cell(33, 7, $customer['addNumber'], 1, 1, 'L');
	// $pdf->ln(1);
	...
	$pdf->Cell(118, 41, $pdf->Image($termsAndConditionImage, $pdf->GetX(), $pdf->GetY(), 118, 41), 1, 1);
	...
	$pdf->Cell(36, 29, $pdf->Image($customerImage, $pdf->GetX(), $pdf->GetY(), 36, 29), 1, 2);
	$pdf->Cell(36, 7, "CUSTOMER IMAGE", 1, 1, 'C', true);
	...
	$pdf->Cell(35, 29, $pdf->Image($sign, $pdf->GetX(), $pdf->GetY(), 35, 32), 1, 2);
