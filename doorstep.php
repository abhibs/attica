                ...
                if ($branch === '') {
                    ...
                    if ($stmt) {
                        ...
                        if ($reqRes && mysqli_num_rows($reqRes) === 1) {
                            ...
                            (customer, contact, type, idnumber, branch, image, quotation, date, time,

                            status, status_remark, issue_remark, remark, remark1, ornament_docs,

                            block_counter, extra, vmtime, reg_type, agent, agent_time, BMId, walkinType)

                            VALUES

                            ('$ecCustomerEsc', '$ecContactEsc', '$ecTypeEsc', NULL,

                            '$ecBranchEsc', NULL, '$ecQuotationEsc', '$ecDateEsc', '$ecTimeEsc',

                            'Begin', NULL, NULL, NULL, NULL, NULL,

                            0, NULL, NULL, 'Doorstep', NULL, NULL, NULL, 'Doorstep')
