...
$sql = "";
$sql = "SELECT * FROM zonalbranch_assign WHERE date='$date'";
		...
		<div class="col-lg-12">
			<div class="hpanel">
				<div class="panel-heading">
					<div class="col-sm-9">
						<h3><i class="fa fa-users" style='color:#990000'></i> Zonal Assigned Branch Report
							...
							<div class="table-responsive">
								<table id="example2" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<?php
										$i = 1;
										// $sql = mysqli_query($con, "SELECT * FROM zonalbranch_assign z,employee e, branch b  WHERE  date = '$date'");
										$sql = mysqli_query($con, "
											SELECT z.*, e.name, b.branchName 
											FROM zonalbranch_assign z
											JOIN employee e ON z.ezviz_vc = e.empId
											JOIN branch b ON z.branchId = b.branchId
											WHERE z.date = '$date'
										");
										while ($row = mysqli_fetch_assoc($sql)) {
											echo "<tr>";
											echo "<td>" . $i .  "</td>";
											echo "<td>" . $row['ezviz_vc'] . "</td>";
											echo "<td>" . $row['name'] . "</td>";
