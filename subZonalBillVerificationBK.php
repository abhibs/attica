	...
	<div class="row content">
		<div class="col-lg-12">
			<div class="hpanel">
					...
					<div class="table-responsive">
						<table id="example5" class="table table-bordered">
							...
							<tbody>							
								...
								if($type == 'SubZonal'){
									if(date('D') == 'Sun'){
										$sql = "SELECT b.branchName, t.id, t.name, t.phone, t.releases, t.grossW, t.netW, t.grossA, t.netA, t.amountPaid, t.time, t.type, t.comm, t.paymentType, t.cashA, t.impsA, t.metal,t.branchId
										FROM trans t
               ...
               t.cashA, t.impsA, t.metal, t.branchId
        FROM trans t
	JOIN branch b ON t.branchId = b.branchId
        ...
        WHERE t.date = '$date' 
          ...
          AND b.ezviz_vc = '$emp_id'";
								...
								while($row = mysqli_fetch_assoc($query)){
									...
									echo "<td>".$row['comm']."</td>";
									//echo "<td><a href='./OrnamentDocs/{$row['ornament_docs']}' target='_blank'><img src='./OrnamentDocs/{$row['ornament_docs']}' height='100px' width='100px' alt='Customer Document'></a></td>";
									...
									echo "<td class='text-center'>
										<button class='btn btn-sm'  style='{$btnStyle}'  data-transid='{$row['id']}' data-branchid='{$row['branchId']}' title='{$title}'  onclick='verifyBill(this)' {$disabledAttr}>Verify</button> </td>";
