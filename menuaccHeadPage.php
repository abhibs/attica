<aside id="menu" style="overflow:scroll;overflow-x:hidden">
    <div id="sidebar-collapse">
	    ...
	    <li><a href="callcenter_dashboard.php"><span class="nav-label"><i style="color:#990000" class="fa fa-dashboard"></i> CallCenter Dashboard </span></a></li>
	    ...
	    <li><a href="addCustomerZonal.php"><i style="color:#990000" class="fa fa-user-plus"></i> Add Customer</a></li>
			<li><a href="chatzonalimps.php"><span class="nav-label"><i style="color:#990000" class="fa fa-envelope"></i> ZonalChat</span></a></li>
			...
			<li><a><span class="nav-label"><b><i style="color:#990000" class="fa fa-file-text"></i> Transactions</span><span class="fa arrow"></span></b> </a>
			...
			<li><a><span class="nav-label"><b><i style="color:#990000" class="fa fa-file-text"></i> Reports</b></span><b><span class="fa arrow"></span></b></a>
				<ul class="nav nav-second-level">
					<li><a href="cashreminders.php">Cash Clusters</a></li >
					<li><a href="masterGoldReport.php">Gold SQL</a></li >
					...
					<li><a href="goldsmelterInfo.php">Gold Melting Report</a></li>
				</ul>
			</li>
