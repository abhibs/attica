<aside id="menu" style="overflow:scroll;overflow-x:hidden">
    <div id="sidebar-collapse">
        <ul class="nav" id="side-menu">
            <li><a href="sundayUserDashboard.php"><i style="color:#990000" class="fa fa-tachometer"></i> Dashboard</a></li>
            <!-- <li><a href="assignZonalBranch1.php"><i style="color:#990000" class="fa pe-7s-users"></i> Zonal Assign</a></li> -->
            <!-- <li><a href="zonalShuffle.php"><i style="color:#990000" class="fa fa-random"></i> Zonal Shuffle</a></li> -->
            <li><a href="zonalBillVerification.php"><span class="nav-label"><i style="color:#990000; width:20px;" class="fa fa-check-circle-o"></i> Verify Bill</span></a></li>
            <li><a href="issues.php"><span class="nav-label"><i style="color:#990000; width:20px;" class="fa fa-info-circle"></i> Enquiry </span></a></li>
	...
	<li><a href="xapproveRelease.php"><i style="color:#990000;width:20px" class="fa fa-inbox" aria-hidden="true"></i> Release </a></li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="displayQuotation.php"> Waiting</a></li>
                    <li><a href="xmanageCustomer.php"> Blocked </a></li>
                </ul>
            </li>


            <!-- <li><a href="enquiryWalkinReport.php"><span class="nav-label"><i style="color:#990000;width:20px" class="fa fa-users"></i> Walkin</span></a></li>-->
		...
		<ul class="nav nav-second-level">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="assignBranch.php"> Assign Branch</a></li>
            ...
            <li><a><span class="nav-label"><b><i style="color:#990000;width:20px" class="fa fa-file-text"></i> Reports</b></span><b><span class="fa arrow"></span></b></a>
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="viewbillzonal.php">Transaction Report</a></li>
                    <li><a href="enquiryReportAll.php">Enquiry Report</a></li>
                    <li><a href="SendingReportZonal.php">Send Report</a></li>
            ...
            <li><a href="#"><span class="nav-label"><b><i style="color:#990000;width:20px" class="fa fa-file-text-o"></i> VM Details</b></span><b><span class="fa arrow"></span></b></a>
                <ul class="nav nav-second-level">
