        ...
        <div class="row">
            <div class="col-lg-9">
                <h3 class="text-success no-margins">
                    <a type='button' class='btn btn-success' href="subDisplayQuotation.php"><span style="color:#ffcf40" class="fa fa-share-square-o"></span> QUOTATION</a>
                </h3>
            </div>
            <div class="col-lg-3">
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php
                                        $i = 1;
                                        // Added walkinType to SELECT (only change)
                                        $query = mysqli_query($con,"SELECT customer, contact, quotation, status, extra, time, walkinType 
                                        FROM everycustomer 
                                    ...
                                    <div class="panel-body" >
                                        <table id="example5" class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php 
                                                    $i = 1;
                                                    // Added e.walkinType to SELECT (only change)
                                                    $sql = "SELECT e.customer, e.contact, e.quotation, e.status, e.time, e.extra, e.type, e.walkinType, b.branchName 
                                                    FROM everycustomer e,branch b 
                                                    WHERE e.date='$date' AND e.status IN ('0','Blocked','Begin') AND e.branch=b.branchId AND b.ezviz_vc = '$employeeId'
                                                    ORDER BY e.Id DESC";
