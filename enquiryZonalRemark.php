...
if (isset($_POST['submitSave'])) {
	...
	if (mysqli_query($con, $sql)) {
		...
		header("Location:subEnquiryWalkinReport.php");
	} else {
							...
							<tr>
								...
								<td class="text-right" style="border-top: hidden; border-right: hidden;">
									<?php if ($enquiryData['quotation'] != '') {  ?>
										<a style="background-color:#123C69; color:#ffffff; padding:5px 15px 5px 15px;" target='_BLANK' href='KaratMachine/<?php echo $enquiryData['karatM']; ?>'>Karat Machine Image <span class='fa fa-external-link' style="color:#ffcf40; margin-left: 7px;"></span>
										</a>
									<?php } else { ?>
										No Quotation Given
									<?php } ?>
								...
								<td class="text-right" style="border-top: hidden; border-right: hidden;">
									<?php if ($enquiryData['enquiry_image'] != '') {  ?>
										<a style="background-color:#123C69; color:#ffffff; padding:5px 15px 5px 15px;" target='_BLANK' href='WeightMachine/<?php echo $enquiryData['weightM']; ?>'>Weight Machine Image <span class='fa fa-external-link' style="color:#ffcf40; margin-left: 7px;"></span>
										</a>
									<?php } else { ?>
										No Image
									<?php } ?>
								...
								<td class="text-right" style="border-top: hidden; border-right: hidden;">
									<?php if ($enquiryData['enquiry_image'] != '') {  ?>
										<a style="background-color:#123C69; color:#ffffff; padding:5px 15px 5px 15px;" target='_BLANK' href='EnquiryImage/<?php echo $enquiryData['enquiry_image']; ?>'>Gold Image <span class='fa fa-external-link' style="color:#ffcf40; margin-left: 7px;"></span>
										</a>
									<?php } else { ?>
										No Image
									<?php } ?>
