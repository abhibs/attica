...
if ($branchKey !== '') {
    $sql = "SELECT id, name, contact_number, location, metal_type, grams, release_amount,
                   branch, business_type, release_place, release_doc, gold_image, customer_id_doc,
    ...
    if ($stmt = mysqli_prepare($con, $sql)) {
        ...
        while ($row = mysqli_fetch_assoc($res)) {
            ...
            $releaseAmount  = htmlspecialchars($row['release_amount'] ?? '', ENT_QUOTES, 'UTF-8'); // NEW
