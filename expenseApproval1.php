...
<style>
    ...
    .table-bordered th,
    .table-bordered td {
      border: 3px solid #000 !important; /* Make borders thicker */
    }
    .table-bordered {
				...
				<div class="tab" role="tabpanel">
					...
					<div class="tab-content">
							...
							<div class="panel-body">
								<table id="example2" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										$monthlyTypes = ["Office Rent", "Others", "Electricity Bill", "Internet Bill", "Telephone Bill", "Water Bill", "Salary", "Salary Advance", "Incentives", "Advertisement Expenses", "Office Maintenance", "Legal Expense", "MD Sir Payment", "Stationary Expense", "IT Expense"];
										...
										while ($rowA = mysqli_fetch_assoc($sqlA)) {
											...
											// Determine row color
											$rowStyle = "";
											if (in_array($rowA['type'], $dailyTypes)) {
												$rowStyle = "style='background-color:#d4edda;'"; // Light green
											} elseif (in_array($rowA['type'], $monthlyTypes)) {
								...
								<table id="example3" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										while ($rowB = mysqli_fetch_assoc($sqlB)) {
											...
											// Determine row color
											$rowStyle = "";
											if (in_array($rowB['type'], $dailyTypes)) {
												$rowStyle = "style='background-color:#d4edda;'"; // Green for daily
											} elseif (in_array($rowB['type'], $monthlyTypes)) {
												$rowStyle = "style='background-color:#f8d7da;'"; // Red for monthly
											}
						...
						<div id="tab-3" class="tab-pane">
							<div class="panel-body">
								<table id="example4" class="table table-striped table-bordered table-hover" style="">
									<thead>
										<tr class="theadRow">
											<th><i class="fa_Icon fa fa-sort-numeric-asc"></i></th>
											<th>BranchName</th>
									...
									<tbody>
										...
										while ($rowC = mysqli_fetch_assoc($sqlC)) {
											...
											$rowStyle = "";
											if (in_array($rowC['type'], $dailyTypes)) {
												$rowStyle = "style='background-color:#d4edda;'"; // Light green for daily expenses
											} elseif (in_array($rowC['type'], $monthlyTypes)) {
												$rowStyle = "style='background-color:#f8d7da;'"; // Light red for monthly expenses
											}
